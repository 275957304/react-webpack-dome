...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	(0, _reactDom.render)(_react2.default.createElement(_NewsList2.default, null), (0, _jquery2.default)('#app')[0]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewsItem = __webpack_require__(176);
	...
	var NewsHeader = function (_React$Component) {
		...
		_createClass(NewsHeader, [{
			...
			value: function getLogo() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('img', { width: '20', height: '20', src: _logo2.default })
					)
				);
			}
		}, {
			...
			value: function getNav() {
				var navLinks = [{ name: 'new', url: 'newest' }, { name: 'comments', url: 'newcomments' }, { name: 'show', url: 'show' }, { name: 'ask', url: 'ask' }, { name: 'jobs', url: 'jobs' }, { name: 'submit', url: 'submit' }];
				return _react2.default.createElement(
					'div',
					...
					navLinks.map(function (item) {
						return _react2.default.createElement(
							'a',
							{ key: item.url, className: 'newsHeader-navLink textLink', href: "https://myurl/" + item.url },
							item.name
						);
					})
				);
			...
			value: function getLogin() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'a',
						{ className: 'newsHeader-textLink', href: 'https://myurl/login?goto=news' },
						'login'
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "e6552121fc8277a5dbd8184e1d79f2a6.png";
